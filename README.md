...
![Website](Assets/Question-2/Cipher.png)
...
![Decode](Assets/Question-2/Decrypt.png)
...
|---|---|---|
| 21/tcp | FTP (vsftpd 2.3.4) | Anonymous login, backdoor shell, brute-force |
| 22/tcp | SSH (OpenSSH 5.3p1) | Username enumeration, brute-force, exploitation of older cryptographic vulnerabilities |
| 80/tcp | HTTP (Apache 2.2.8) | Server fingerprinting, DoS attack, exploit outdated Apache bugs |
...
| 22 | OpenSSH 5.3p1 | **CVE-2018-15473** Username Enumeration, outdated SSH daemons allow attackers by analyzing the server's response timing |
| 80 | Apache 2.2.8 | **CVE-2007-6750** XSS vulnerabilities, **CVE-2012-0053** (DoS), highly susceptible to the Slowloris attack |
...
| Area | Action |
|---|---|
| Update & Patch | Upgrade vsftpd, Apache, and OpenSSH to their latest stable versions |
